...
<script type="text/javascript">
    ...
    function policeLogin() {
        $("#policeLoginForm").attr("action", "<%=policePath %>login.do").submit();
    };
    
    function clearFormData(){
        $("#policeLoginForm #account").val("");
        $("#policeLoginForm #password").val("");
    };
	...
	<div class="modal-dialog"
		...
		<div class="modal-content">
			...
			<div class="modal-body" id="model-body" style="height: 220px">
				<form id="policeLoginForm" class="form-horizontal" role="form">
