...
<script type="text/javascript">
	...
	function EnterPress(e){ //传入 event 
		...
		if(e.keyCode == 13){
			$("#loginform").attr("action", "<%=policePath %>login").submit();
		}
	}
</script>
    ...
    <div class="modal-dialog" style="margin-top: 10%;width: 500px; height:500px">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title text-center" id="myModalLabel">警&nbsp;&nbsp;察&nbsp;&nbsp;登&nbsp;&nbsp;录</h4>
            </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10">
						    <div class="input-group">
								<input  id="password" name="password" type="text" class="form-control" placeholder="密码" autocomplete="off" style="width: 310px;height:40px;">
							</div>		
					    </div>
					  </div>
				</form>  
            ...
            <div class="modal-footer">   
            	<a type="button" class="btn btn-primary" href ="find_info.jsp" >登录</a>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
