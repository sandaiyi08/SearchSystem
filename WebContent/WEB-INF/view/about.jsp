...
<body>
				...
				<div class="text-right ">
					<div>
						...
						<c:if test="${empty police && empty user}">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="<%=policePath %>login"
								style="color: #ffffff">警务服务</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="<%=userPath %>login"
								style="color: #ffffff">用户服务</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="<%=indexPath %>about"
								style="color: #ffffff">关于我们</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="<%=userPath %>login"
						...
						<c:if test="${!empty police && empty user}">
							<a href="<%=indexPath %>index" style="color: #ffffff">首页</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="<%=policePath %>find"
								style="color: #ffffff">警务服务</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="<%=policePath %>message"
								style="color: #ffffff">个人中心</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="<%=indexPath %>about"
								style="color: #ffffff">关于我们</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="<%=policePath %>logout"
								style="color: #ffffff">登出</a>
						</c:if>
						<c:if test="${empty police && !empty user}">
							<a href="<%=indexPath %>index" style="color: #ffffff">首页</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="<%=userPath %>message"
								style="color: #ffffff">用户服务</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="<%=indexPath %>about"
								style="color: #ffffff">关于我们</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="<%=userPath %>logout"
								style="color: #ffffff">登出</a>
						</c:if>
	...
	<div class="container" style="width: 1000px; height: 300px">
		<div class="col-md-4" style="width: 450px">
			<div
				style="height: 180px; margin-left: 40px; margin-top: 80px; font-size: 16px; line-height: 30px;">
	...
	<div class="container" style="width: 1000px; height: 250px">
		...
		<div class="col-md-4" style="width: 500px">
			<div
				style="height: 200px; margin-left: 95px; margin-top: 50px; font-size: 16px; line-height: 30px">
	...
	<div class="container" style="width: 1000px; height: 300px">
		<div class="col-md-5" style="width: 450px">
			<div
				style="height: 250px; margin-left: 40px; margin-top: 110px; font-size: 16px; line-height: 30px">
				<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;在老人及其家属信息已经注册登记的情况下，只需对老人的面部信息进行识别，便会迅速得到老人家属的联系方式，为了保障家属的信息安全，我们仅是提供家属的姓名以及电话号码，并不会泄漏重要信息。</p>
			</div>
		</div>
		<div class="col-md-4"
			style="margin-top: 30px; width: 200px; margin-left: 20px;">
			<div style="height: 300px; margin-left: 28px;">
